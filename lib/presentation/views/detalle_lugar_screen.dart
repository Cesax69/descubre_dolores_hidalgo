  ...
  void initState() {
    ...
    if (video != null) {
      _videoController = VideoPlayerController.asset(video)
        ..initialize().then((_) => setState(() {})).catchError((e) { print(e); });
    }
  }
      ...
      body: ListView(
        children: [
          Image.asset(widget.lugar.imagenAsset, height: 220, width: double.infinity, fit: BoxFit.cover,
            errorBuilder: (context, error, stackTrace) => Container(height: 220, color: Colors.grey, child: const Icon(Icons.image, size: 50))),
          Padding(
